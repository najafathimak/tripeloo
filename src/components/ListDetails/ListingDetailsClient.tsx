...
const BookingSidebar = ({
  ...
  // Mobile view: Inline form + Fixed button + Modal
  if (isMobile) {
    return (
      <>
        {/* Inline Booking Form - Mobile Only */}
        <div ref={formSectionRef} className="md:hidden mb-5">
          <div className="border shadow-md p-6 bg-white rounded-2xl">
        ...
        {/* Fixed Bottom Button - Mobile Only (Hidden when form section is visible) */}
        {showFixedButton && (
          <div className="fixed bottom-6 left-0 right-0 z-40 md:hidden flex justify-center px-4 pointer-events-none transition-opacity duration-300">
            <button
        ...
        {isModalOpen && (
          ...
          >
            ...
            <div
              className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl shadow-2xl max-h-[90vh] overflow-y-auto transform transition-transform duration-300 ease-out"
            ...
            >
              ...
              <div className="sticky top-0 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between rounded-t-3xl z-10">
                <div className="flex-1 min-w-0">
                  <h2 className="text-gray-800 font-semibold text-lg line-clamp-1">{title}</h2>
  ...
  return (
    <div
      className={`
        border shadow-md p-6 bg-white rounded-2xl sticky top-24
        ${className}
      `}
    >
